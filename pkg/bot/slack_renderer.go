...
func (b *SlackRenderer) RenderEventMessage(event event.Event, additionalSections ...api.Section) api.Message {
	...
	return api.Message{Sections: sections}
}

// RenderModal returns a modal request view based on a given message.
func (b *SlackRenderer) RenderModal(msg api.Message) slack.ModalViewRequest {
	title := msg.Header
	msg.Header = ""
...
func (b *SlackRenderer) RenderInteractiveMessage(msg api.Message) slack.MsgOption {
...
func (b *SlackRenderer) RenderAsSlackBlocks(msg api.Message) []slack.Block {
...
func (b *SlackRenderer) renderAsSimpleTextSection(msg api.Message) slack.MsgOption {
